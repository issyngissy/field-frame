  ...
  return (
    <div style={{ background: '#0a0a0a', minHeight: '100vh', color: '#fff', fontFamily: 'monospace', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ background: '#111', border: '1px solid #222', borderRadius: '8px', padding: '40px', width: '360px' }}>
        ...
        <input
          type = 'email'
          style={{ background: '#1a1a1a', border: '1px solid #333', color: '#fff', padding: '10px', borderRadius: '6px', width: '100%', marginBottom: '12px', boxSizing: 'border-box' as const }}
          placeholder='Email'
        ...
        <input
          type='password'
          style={{ background: '#1a1a1a', border: '1px solid #333', color: '#fff', padding: '10px', borderRadius: '6px', width: '100%', marginBottom: '20px', boxSizing: 'border-box' as const }}
